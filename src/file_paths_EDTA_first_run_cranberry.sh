...
output_file=/mnt/research/edgerpat_lab/Scotty/Blueberry_Pangenome_TE_Analysis/results/Cranberry/file_paths.txt
rm -f $output_file

for dir in $(find /mnt/research/edgerpat_lab/Scotty/Blueberry_Pangenome_TE_Analysis/results/Cranberry -mindepth 1 -type d)
do
	processed_CDS_FASTA=
	processed_FASTA=
